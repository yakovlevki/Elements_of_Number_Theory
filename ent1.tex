...
\begin{document}
    ...
    \begin{theorem} \label{th9.3}
        Пусть $f(x)$ - произвольная целозначная функция, $m>2$ - целое, причем $m=km$, где $k,n>1,\ (k,n)=1$. Пусть далее
        \[\begin{cases}
            x\equiv a_1\pmod{k},\\
            \tab[1.5cm]\vdots\\
            x\equiv a_r \pmod{k}.  
    ...
    \begin{proof}
        ...
        \Rightarrow a_k=\frac{\Delta_k}{\Delta}$
        \[\Delta=\begin{vmatrix}
            1 & x_1 & x_1^2 & \dots & x_1^n\\
            1 & x_2 & x_2^2 & \dots & x_2^n\\
            \vdots & \vdots & \vdots & \null & \vdots\\
            1 & x_{n+1} & x_{n+1}^2 & \dots & x_{n+1}^n
        \end{vmatrix} = \prod\limits_{1\leq j < i\leq n+1}(x_j-x_i)\]
    ...
    \begin{lemma}\label{lemma9.1}
        Пусть $f(x)=a_nx^n+ \dots +a_1 x+a_0$ - многочлен с целыми коэффициэнтами, и пусть $\Delta$ - целое число. Тогад при любом $x$ справедливо равенство: $f(x+\Delta)-f(x)=\Delta\cdot a f^{\prime}(x)+\Delta^2g(x)$, где $g(x)$ - некоторый многочлен с целыми коэффициэнтами.
    \end{lemma} 
    \begin{proof}
        \begin{multline*}
